...
const PROJECTS: Project[] = [
  {
    ...
    techStack: ["React", "TypeScript", "Tailwind CSS", "Node.js", "Vercel", "Claude"],
    features: [
  ...
  {
    id: 5,
    title: "Lyvera Studio Digital Marketing",
    category: "Development",
    description: "Designed and developed website for a digital marketing agency to showcase their services and portfolio.",
    image: "https://scontent.fcrk1-2.fna.fbcdn.net/v/t39.30808-6/672679028_122093459624658152_2753157355145932_n.jpg?stp=dst-jpg_tt6&cstp=mx1080x1080&ctp=s1080x1080&_nc_cat=104&ccb=1-7&_nc_sid=6ee11a&_nc_ohc=NHA55TVHo6kQ7kNvwGGsEPF&_nc_oc=AdrKbPQQufhO6KsbtIsF0Q9sjJbBgZOi9tC_EpwwvrckN7WqPCM3VzMvvb6_qioq3yI&_nc_zt=23&_nc_ht=scontent.fcrk1-2.fna&_nc_gid=iJ1bknLYbzXLQlS-4LwoAg&_nc_ss=7b2a8&oh=00_Af9lbFLzsesZ6wf_Ed6YjumU_Fpz0hcOn4xB6s7BNV1g3w&oe=6A308F3A",
    techStack: ["React", "Tailwind CSS", "Node.js", "Vercel", "Claude"],
    features: [
